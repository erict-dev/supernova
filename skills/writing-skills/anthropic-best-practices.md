...
Executable scripts sit alongside instruction files. The instruction file (e.g., forms.md) references the script, and Claude executes it without loading its contents into context.
