...
5. **Write design doc** — save to `docs/supernova/YYYY-MM-DD-<topic>/design.md` and commit
...
- Break the system into units with one purpose, well-defined interfaces, and no hidden dependencies. If you can't describe what a unit does without reading its internals, the boundaries need work.
- Prefer smaller, focused files — they're easier to reason about and edit reliably. A file growing large often signals it's doing too much.
...
- Write the validated design (spec) to `docs/supernova/YYYY-MM-DD-<topic>/design.md`
